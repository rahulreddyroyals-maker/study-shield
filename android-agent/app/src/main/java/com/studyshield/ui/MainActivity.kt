...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Check permissions — redirect to setup if missing
    ...
    private fun buildUI() {
        ...
        card.addView(TextView(this).apply {
            text = "Share this Device ID with the parent when adding this phone to the Study Shield app."
            textSize = 12f
        ...
        root.addView(Button(this).apply {
            ...
            setOnClickListener {
                ...
                clipboard.setPrimaryClip(ClipData.newPlainText("Study Shield Device ID", deviceId))
                Toast.makeText(context, "✅  Device ID copied!", Toast.LENGTH_SHORT).show()
            }
        })

        // Status badge
        val isActive = AppMonitorService.isRunning
        root.addView(TextView(this).apply {
            text = if (isActive) "✅  Monitoring active" else "⏸  Waiting for study session from parent..."
            textSize = 13f
            setTextColor(if (isActive) 0xFF22C55E.toInt() else 0xFF94A3B8.toInt())
            gravity = Gravity.CENTER
            setPadding(0, 8, 0, 0)
        })
        ...
        // Version footer
        root.addView(TextView(this).apply {
            text = "Study Shield v1.0 · studyshield-ai.web.app"
            textSize = 11f
