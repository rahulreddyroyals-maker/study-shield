...
class BlockedActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleLp.topMargin = 16; titleLp.bottomMargin = 8
        root.addView(TextView(this).apply {
            text = "App Blocked"; textSize = 28f; setTextColor(0xFFFFFFFF.toInt())
            typeface = Typeface.DEFAULT_BOLD; gravity = Gravity.CENTER; layoutParams = titleLp
        })
        ...
        root.addView(TextView(this).apply {
            ...
            lineSpacingExtra = 4f; layoutParams = subLp
        })
        val badgeLp = LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT)
        badgeLp.gravity = Gravity.CENTER_HORIZONTAL; badgeLp.bottomMargin = 40
        root.addView(TextView(this).apply {
            text = "  🛡️  Study Shield is protecting your focus  "
            textSize = 12f; setTextColor(0xFF22C55E.toInt()); setPadding(20,10,20,10)
            gravity = Gravity.CENTER; layoutParams = badgeLp
        ...
        btnLp.bottomMargin = 12
        root.addView(Button(this).apply {
            text = "📚  Back to studying"; textSize = 16f; isAllCaps = false
            setTextColor(0xFFFFFFFF.toInt()); setPadding(0,48,0,48); layoutParams = btnLp
        ...
        val emergLp = LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT)
        emergLp.bottomMargin = 48
        root.addView(Button(this).apply {
            text = "📞  Emergency call"; textSize = 14f; isAllCaps = false
            setTextColor(0xFFEF4444.toInt()); setBackgroundColor(0); layoutParams = emergLp
            setOnClickListener { Toast.makeText(this@BlockedActivity,"Emergency — parent notified!",Toast.LENGTH_LONG).show(); finish() }
        })
        root.addView(TextView(this).apply {
            text = quotes.random(); textSize = 12f; setTextColor(0xFF334155.toInt())
