...
class MainActivity : AppCompatActivity() {
    ...
    private fun buildUI() {
        ...
        val root = LinearLayout(this).apply {
            orientation = LinearLayout.VERTICAL; gravity = Gravity.CENTER; setPadding(48, 96, 48, 80)
        }
        ...
        val card = LinearLayout(this).apply {
            orientation = LinearLayout.VERTICAL; setPadding(36,28,36,28); layoutParams = cardLp
        ...
        root.addView(Button(this).apply {
            ...
            setTextColor(0xFFFFFFFF.toInt()); setPadding(0,44,0,44); layoutParams = btnLp
